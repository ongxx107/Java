...
//        strategyProviders.add(new ClassStrategyProvider(RandomStrategy.class));
        ...
        strategyProviders.add(new JarStrategyProvider("final_project_4"));
//        strategyProviders.add(new JarStrategyProvider("AI3_obf"));
    ...
    /**
     * Class providing instances of a strategy which can be referred to directly, e.g. {@code Strategy.class}
     */
